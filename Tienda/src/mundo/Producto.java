...
public class Producto {
    ...
    /**
     * Se crea el metodo por la necesidad del metodo cambiarProducto() en la clase Tienda
     *
     * @param pRutaImagen Nueva ruta de la imagen del producto.
     */
    ...
    public void cambiardarCantidadUnidadesVendidas(int nuevaCantidadUnidadesVendidas) {
        ...
        this.cantidadUnidadesVendidas += nuevaCantidadUnidadesVendidas; // Usamos += para ir actualizando las unidades vendidas
    }
    ...
    public int vender(int pCantidad) {
        ...
        if (pCantidad <= cantidadBodega) {
            // Se pueden vender todas las unidades solicitadas
            cantidadVendida = pCantidad;
            cantidadBodega -= pCantidad;
            cantidadUnidadesVendidas += pCantidad;
        } else {
            // No hay suficientes unidades en bodega para vender todas
            cantidadVendida = cantidadBodega;
            cantidadBodega = 0;
            cantidadUnidadesVendidas = cantidadUnidadesVendidas + cantidadBodega;
        }
